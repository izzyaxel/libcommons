...
[[nodiscard]] std::string subString(std::string const &input, uint32_t const &distFromStart, uint32_t const &distFromEnd);
...
[[nodiscard]] std::vector<std::string> splitSeq(std::string const &input, std::string const &splitOn);

/// Split a string on any of the given words
[[nodiscard]] std::vector<std::string> splitSeqMult(std::string const &input, std::vector<std::string> const &splitOn);
