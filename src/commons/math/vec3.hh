...
template<typename T> struct vec3
{
	...
	[[nodiscard]] inline vec3<T> zyx() const { return vec3<T>{this->data[2], this->data[1], this->data[0]};}
	[[nodiscard]] inline vec3<T> xxy() const { return vec3<T>{this->data[0], this->data[0], this->data[1]};}
	[[nodiscard]] inline vec3<T> xxz() const { return vec3<T>{this->data[0], this->data[0], this->data[2]};}
	[[nodiscard]] inline vec3<T> yyx() const { return vec3<T>{this->data[1], this->data[1], this->data[0]};}
	[[nodiscard]] inline vec3<T> yyz() const { return vec3<T>{this->data[0], this->data[1], this->data[2]};}
	[[nodiscard]] inline vec3<T> zzx() const { return vec3<T>{this->data[2], this->data[2], this->data[0]};}
	[[nodiscard]] inline vec3<T> zzy() const { return vec3<T>{this->data[2], this->data[2], this->data[1]};}
	[[nodiscard]] inline vec3<T> xyy() const { return vec3<T>{this->data[0], this->data[1], this->data[1]};}
	[[nodiscard]] inline vec3<T> xzz() const { return vec3<T>{this->data[0], this->data[2], this->data[2]};}
	[[nodiscard]] inline vec3<T> yxx() const { return vec3<T>{this->data[1], this->data[0], this->data[0]};}
	[[nodiscard]] inline vec3<T> yzz() const { return vec3<T>{this->data[1], this->data[2], this->data[2]};}
	[[nodiscard]] inline vec3<T> zxx() const { return vec3<T>{this->data[2], this->data[0], this->data[0]};}
	[[nodiscard]] inline vec3<T> zyy() const { return vec3<T>{this->data[2], this->data[1], this->data[1]};}
	[[nodiscard]] inline vec3<T> xyx() const { return vec3<T>{this->data[0], this->data[1], this->data[0]};}
	[[nodiscard]] inline vec3<T> xzx() const { return vec3<T>{this->data[0], this->data[2], this->data[0]};}
	[[nodiscard]] inline vec3<T> yxy() const { return vec3<T>{this->data[1], this->data[0], this->data[1]};}
	[[nodiscard]] inline vec3<T> yzy() const { return vec3<T>{this->data[1], this->data[2], this->data[1]};}
	[[nodiscard]] inline vec3<T> zxz() const { return vec3<T>{this->data[2], this->data[0], this->data[2]};}
	[[nodiscard]] inline vec3<T> zyz() const { return vec3<T>{this->data[2], this->data[1], this->data[2]};}
	[[nodiscard]] inline vec3<T> xzy() const { return vec3<T>{this->data[0], this->data[2], this->data[1]};}
	[[nodiscard]] inline vec3<T> yzx() const { return vec3<T>{this->data[1], this->data[2], this->data[0]};}
	...
	[[nodiscard]] inline vec3<T> bgr() const { return vec3<T>{this->data[2], this->data[1], this->data[0]};}
	[[nodiscard]] inline vec3<T> rrg() const { return vec3<T>{this->data[0], this->data[0], this->data[1]};}
	[[nodiscard]] inline vec3<T> rrb() const { return vec3<T>{this->data[0], this->data[0], this->data[2]};}
	[[nodiscard]] inline vec3<T> ggr() const { return vec3<T>{this->data[1], this->data[1], this->data[0]};}
	[[nodiscard]] inline vec3<T> ggb() const { return vec3<T>{this->data[0], this->data[1], this->data[2]};}
	[[nodiscard]] inline vec3<T> bbr() const { return vec3<T>{this->data[2], this->data[2], this->data[0]};}
	[[nodiscard]] inline vec3<T> bbg() const { return vec3<T>{this->data[2], this->data[2], this->data[1]};}
	[[nodiscard]] inline vec3<T> rgg() const { return vec3<T>{this->data[0], this->data[1], this->data[1]};}
	[[nodiscard]] inline vec3<T> rbb() const { return vec3<T>{this->data[0], this->data[2], this->data[2]};}
	[[nodiscard]] inline vec3<T> grr() const { return vec3<T>{this->data[1], this->data[0], this->data[0]};}
	[[nodiscard]] inline vec3<T> gbb() const { return vec3<T>{this->data[1], this->data[2], this->data[2]};}
	[[nodiscard]] inline vec3<T> brr() const { return vec3<T>{this->data[2], this->data[0], this->data[0]};}
	[[nodiscard]] inline vec3<T> bgg() const { return vec3<T>{this->data[2], this->data[1], this->data[1]};}
	[[nodiscard]] inline vec3<T> rgr() const { return vec3<T>{this->data[0], this->data[1], this->data[0]};}
	[[nodiscard]] inline vec3<T> rbr() const { return vec3<T>{this->data[0], this->data[2], this->data[0]};}
	[[nodiscard]] inline vec3<T> grg() const { return vec3<T>{this->data[1], this->data[0], this->data[1]};}
	[[nodiscard]] inline vec3<T> gbg() const { return vec3<T>{this->data[1], this->data[2], this->data[1]};}
	[[nodiscard]] inline vec3<T> brb() const { return vec3<T>{this->data[2], this->data[0], this->data[2]};}
	[[nodiscard]] inline vec3<T> bgb() const { return vec3<T>{this->data[2], this->data[1], this->data[2]};}
	[[nodiscard]] inline vec3<T> rbg() const { return vec3<T>{this->data[0], this->data[2], this->data[1]};}
	[[nodiscard]] inline vec3<T> gbr() const { return vec3<T>{this->data[1], this->data[2], this->data[0]};}
	[[nodiscard]] inline vec3<T> brg() const { return vec3<T>{this->data[2], this->data[0], this->data[1]};}
	...
	/// Get an inverted v3
	[[nodiscard]] inline vec3<T> inverse() const
	{
		return vec3<T>{-this->data[0], -this->data[1], -this->data[2]};
	}
	...
	/// Get a normalized v3
	[[nodiscard]] inline vec3<T> normalized() const
	{
		vec3<T> out;
		T length = this->mag();
	...
	[[nodiscard]] inline static vec3<T> rotateFromMouseEuler(T xrel, T yrel, T lookSensitivity)
	{
		vec3<T> out{};
	...
	[[nodiscard]] inline bool isCardinal() const
	{
